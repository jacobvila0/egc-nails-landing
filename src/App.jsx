...
return ( <div className="min-h-screen bg-[#fff7f2] text-stone-900"> <header className="sticky top-0 z-50 border-b border-rose-100 bg-white/80 backdrop-blur"> <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4"> <div> <p className="text-xs uppercase tracking-[0.3em] text-rose-400">
Beauty Studio </p> <h1 className="text-xl font-bold tracking-tight">EGC.NAILS</h1> </div>
  ...
  <main>
    ...
    <section id="peinados" className="bg-[#fff7f2] px-5 py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 max-w-2xl">
          ...
          <p className="mt-4 text-stone-600">
            También puedes pedir cita para recogidos y secados. Ideales para
            eventos, ocasiones especiales o para verte arreglada con un
            acabado cuidado.
          </p>
        </div>
        ...
        <div className="-mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto scroll-smooth px-5 pb-4 [scrollbar-width:none] md:mx-0 md:grid md:grid-cols-2 md:overflow-visible md:px-0 md:pb-0 [&::-webkit-scrollbar]:hidden">
          <Card className="min-w-[88%] snap-center overflow-hidden rounded-[2rem] border-rose-100 bg-white shadow-xl shadow-rose-100/60 md:min-w-0">
            <div className="relative">
              <video
                ...
                playsInline
                preload="metadata"
                className="h-[460px] w-full bg-stone-100 object-cover md:h-[520px]"
              />
            ...
            <CardContent className="p-6">
              ...
              <p className="mt-3 leading-7 text-stone-600">
                Un acabado cuidado para eventos, celebraciones o días
                especiales.
              </p>
              <a
                href="#citas"
          ...
          <Card className="min-w-[88%] snap-center overflow-hidden rounded-[2rem] border-rose-100 bg-white shadow-xl shadow-rose-100/60 md:min-w-0">
            ...
            <CardContent className="p-6">
              <h3 className="text-xl font-bold">
                Secado con acabado bonito
              </h3>
              <p className="mt-3 leading-7 text-stone-600">
                Para conseguir un look pulido, natural y favorecedor sin
                complicarte.
              </p>
              <a
                href="#citas"
    ...
    <section id="trabajos" className="px-5 py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-stone-600">
              Inspírate con algunos diseños y acabados recientes de
              EGC.NAILS.
            </p>
          </div>
        ...
        <div className="-mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto scroll-smooth px-5 pb-4 [scrollbar-width:none] md:mx-0 md:grid md:grid-cols-2 md:overflow-visible md:px-0 md:pb-0 lg:grid-cols-3 [&::-webkit-scrollbar]:hidden">
          {trabajos.map((trabajo) => (
            <Card
              key={trabajo.titulo}
              className="min-w-[82%] snap-center overflow-hidden rounded-[1.5rem] border-rose-100 bg-white shadow-sm md:min-w-0"
            >
              <img
                src={trabajo.imagen}
                alt={trabajo.titulo}
